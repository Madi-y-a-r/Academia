  ...
  return (
    <div className="billing">
      <div className="billing__container">
        <h2 className="billing__title">{t("title")}</h2>
            ...
            <Table className="billing__table">
              <TableHeader className="billing__table-header">
                <TableRow className="billing__table-header-row">
                  <TableHead className="billing__table-cell">{t("Date")}</TableHead>
                  <TableHead className="billing__table-cell">{t("Amount")}</TableHead>
